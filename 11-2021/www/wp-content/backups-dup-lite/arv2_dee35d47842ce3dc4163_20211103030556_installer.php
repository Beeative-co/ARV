...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'arv2_dee35d47842ce3dc4163_20211103030556_archive.zip';
	const ARCHIVE_SIZE		 = '1358655346';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'dee35d4-03030556';
    const SECONDARY_PACKAGE_HASH = '0b5034d-03030556';
	const VERSION			 = '1.4.3';
