			...
			<div class='oxygen-control'>
				<div class='oxygen-icon-button-list'>
					...
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-justify-items','left','flex/flex_horiz_left_icon.svg','flex/flex_horiz_left_icon--active.svg',__("Left", "oxygen"), 'iframeScope.setTextAlign()'); ?>
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-justify-items','center',	'flex/flex_horiz_center_icon.svg','flex/flex_horiz_center_icon--active.svg',__("Center", "oxygen"), 'iframeScope.setTextAlign()'); ?>
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-justify-items','right','flex/flex_horiz_right_icon.svg','flex/flex_horiz_right_icon--active.svg',__("Right", "oxygen"), 'iframeScope.setTextAlign()'); ?>
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-justify-items','stretch','flex/flex_horiz_justify_icon.svg','flex/flex_horiz_justify_icon--active.svg',__("Stretch", "oxygen"), 'iframeScope.setTextAlign()'); ?>
		...
		<div class='oxygen-control-wrapper'>
			...
			<div class='oxygen-control'>
				<div class='oxygen-icon-button-list'>
					...
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-align-items','start','flex/flex_vert_top_icon.svg','flex/flex_vert_top_icon--active.svg',__("Start", "oxygen"), ''); ?>
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-align-items','center','flex/flex_vert_middle_icon.svg','flex/flex_vert_middle_icon--active.svg',__("Center", "oxygen"), ''); ?>
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-align-items','end','flex/flex_vert_bottom_icon.svg','flex/flex_vert_bottom_icon--active.svg',__("End", "oxygen"), ''); ?>
					<?php $oxygen_toolbar->icon_button_list_button(
						'grid-align-items','stretch','flex/flex_vert_stretch_icon.svg','flex/flex_vert_stretch_icon--active.svg',__("Stretch", "oxygen"), ''); ?>
