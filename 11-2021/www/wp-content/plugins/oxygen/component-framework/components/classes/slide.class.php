...
Class CT_Slide extends CT_Component {
	...
	function add_shortcode( $atts, $content = null, $name = null ) {
		...
		?><li><div id="<?php echo esc_attr($options['selector']); ?>" class="<?php echo esc_attr($options['classes']); ?>" <?php do_action("oxygen_vsb_component_attr", $options, $this->options['tag']); ?>><?php echo do_shortcode( $content ); ?></div></li><?php
